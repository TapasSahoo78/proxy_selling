...
@section('content')
    <section class="employer-details">
        <div class="row">
            <h2 class="top-hdng">Business Manager</h2>
            <hr>
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 input-bx">
                                                    <label for="exampleInputEmail1" class="form-label">Manager
                                                        Suffix</label>
                                                    <input type="text" class="form-control" aria-describedby="emailHelp">
                                                </div>
                                                <div class="col-lg-6 input-bx">
                                                ...
                                                <div class="col-lg-6 col-md-6 input-bx">
                                                    <label for="exampleInputEmail1" class="form-label">Date Of Join
                                                        ID </label>
                                                ...
                                                <div class="col-lg-6 col-md-6 input-bx">
                                                    ...
                                                    <div class="phone-iput-box form-control">
                                                        <form class="phone-sec">
                                                            <select name="countryCode" id="">
                                                                <option data-countryCode="IN" value="91" Selected>+91
                                                                </option>
