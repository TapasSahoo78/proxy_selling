...
@section('content')
    <section class="employer-details">
        <div class="row">
            <h2 class="top-hdng">Add New Employer</h2>
            <hr>
            ...
            <section class="business-sec">
                ...
                <div class="form-sec">
                    ...
                    <form role="form" class="phone-sec" id="adminFrm" data-action="{{ route('store.employer') }}"
                        method="post">
                        @csrf
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-8 form-sec-left">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 input-bx">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 input-bx">
                                                        ...
                                                        <div class="phone-iput-box form-control">

                                                            <select name="countryCode" id="" style="width: 60px;">
                                                            ...
                                                            <input type="text" class="input-num" name="contact_number">

                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6 col-md-6 input-bx">
                                                        <label class="form-label" name="country">Country
                                                        </label>
                                                    ...
                                                    <div class="col-lg-6  col-md-6 input-bx">
                                                        <label for="exampleInputEmail1" class="form-label"> End
                                                            Date </label>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingTwo">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                ...
                                                Business Employee Ratings
                                            </button>
                                        </h2>
                                        <div id="collapseTwo" class="accordion-collapse collapse show"
                                            aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <div class="add-bus-rtng-btn">
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn-rtng" data-bs-toggle="modal"
                                                        data-bs-target="#RatingModal">
                                                        <img src="../assets/images/Icon ionic-md-add-circle-outline.png"
                                                            alt=""> Add Business Ratings
                                                    </button>
                                                </div>
                                                <!-- Modal -->
                                                <div class="modal fade" id="RatingModal" tabindex="-1"
                                                    aria-labelledby="RatingModalLabel" a ria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">
                                                                    Add Business Ratings</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    <label for="exampleFormControlTextarea1"
                                                                        class="form-label">Rating Category</label>
                                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2"></textarea>
                                                                </div>

                                                                <div class="mb-3">
                                                                    <label for="exampleFormControlTextarea1"
                                                                        class="form-label">Rating Description</label>
                                                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                                                                </div>
                                                                <div class="save-btnnn mt-4">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <div class="add-bus-rtng-btn">
                                                    <!-- Button trigger modal -->
                                                    <button type="button" class="btn-rtng" data-bs-toggle="modal"
                                                        data-bs-target="#QusModal">
                                                        <img src="../assets/images/Icon ionic-md-add-circle-outline.png"
                                                            alt=""> Add Business Ratings
                                                    </button>
                                                </div>
                                                <!-- Modal -->
                                                <div class="modal fade" id="QusModal" tabindex="-1"
                                                    aria-labelledby="QusModalLabel" a ria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">
                                                                    Add Business Questions</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="exampleFormControlTextarea1"
                                                                        class="form-label">Answer Type</label>
                                                                    <div class="y-n">
                            ...
                            <div class="col-lg-4 ">
                                <div class="form-sec-right">
                                    <h4>Upload Images</h4>
                                    <div class="up-img">

                                        <label class="label">
                                            <input type="file" class="default-file-input" name="profile_image">
                                            <span> Employer Profile Image</span></label>
                                    </div>

                                    <div class="up-img upld1">

                                        <label class="label">
                                            <input type="file" class="default-file-input" name="cover_image">
                                            <span> Upload Cover Image </span></label>
                                    </div>


                                    <div class="freqncy mt-4">
                                        ...
                                        <div class="mt-4 mb-5">
                                            <input  class="form-control"
                                                aria-describedby="emailHelp" placeholder="Enter Plan Amount" name="plan_amount">
                                        </div>
                                    </div>
