            ...
            <div class="row">
                <div class="col-md-12 wow fadeInUp">
                    <div class="text-center">
                        <h2><span class="uptitle id-color">Select Your</span>Hosting Plan</h2>
                        <div class="spacer-20"></div>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay=".2s">
                    <div class="pricing-s2 mb30">
                        <div class="top">
                            <img src="{{ asset('user/images/icon-shared-hosting.png') }}" class="size96" alt="">
                            <div class="inner">
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay=".4s">
                    <div class="pricing-s2 bg rec mb30 text-light" data-bgimage="url(images/misc/bg-small-1.jpg)">
                        <div class="inner">
                            <div class="top">
                                <img src="{{ asset('user/images/icon-w-vps-hosting.png') }}" class="size96"
                                    alt="">
                                <div class="clearfix"></div>
                                <h2>VPS Hosting</h2>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay=".6s">
                    <div class="pricing-s2 mb30">
                        <div class="inner">
                            <div class="top">
                                <img src="{{ asset('user/images/icon-cloud-hosting.png') }}" class="size96"
                                    alt="">
                                <div class="clearfix"></div>
                                <h2>Cloud Hosting</h2>
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
